...
var ReactQuill = class extends import_react.default.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return [...this.cleanProps, ...this.dirtyProps].some((prop) => {
      return !(0, import_isEqual4.default)(nextProps[prop], this.props[prop]);
    });
  }
  ...
  */
  isEqualValue(value, nextValue) {
    if (this.isDelta(value) && this.isDelta(nextValue)) {
      return (0, import_isEqual4.default)(value.ops, nextValue.ops);
    } else {
      return (0, import_isEqual4.default)(value, nextValue);
    }
  }
  /*
  ...
  */
  ...
  render() {
    return import_react.default.createElement("div", { id: this.props.id, style: this.props.style, key: this.state.generation, className: `quill ${this.props.className ?? ""}`, onKeyPress: this.props.onKeyPress, onKeyDown: this.props.onKeyDown, onKeyUp: this.props.onKeyUp }, this.renderEditingArea());
  }
  ...
  onEditorChangeSelection(nextSelection, source, editor) {
    ...
    if ((0, import_isEqual4.default)(nextSelection, currentSelection))
      return;
