...
var ClerkHostRenderer = class extends import_react9.default.PureComponent {
  ...
  componentDidUpdate(_prevProps) {
    ...
    if (!(0, import_react8.isDeeplyEqual)(prevProps, newProps) || customPagesChanged || customMenuItemsChanged) {
...
function ClerkContextProvider(props) {
  ...
  const clerkCtx = import_react27.default.useMemo(() => ({ value: clerk }), [clerkLoaded2]);
